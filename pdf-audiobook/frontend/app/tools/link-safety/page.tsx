      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-8 w-full">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-slate-900">Link Safety Scanner</h1>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 p-6 space-y-6 bg-white shadow-sm border border-slate-200/80 backdrop-blur-md">
          ...
          {isProcessing && (
            <div className="space-y-3 p-4 bg-slate-50 border border-slate-200 border border-slate-200 rounded-xl flex flex-col items-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Inspecting annotation links...</p>
            </div>
          )}
        ...
        {links.length > 0 && (
          <section className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="font-semibold text-slate-900 text-lg">Hyperlink Audit</h2>
            ...
            <div className="space-y-3">
              {links.map((link, idx) => (
                <div key={idx} className="p-4 bg-white shadow-sm border border-slate-200/80 border border-slate-200 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-slate-500 font-mono">Page {link.page}</span>
                    ...
                    <div className="bg-black/30 p-2 rounded border border-slate-200/60 font-mono text-[10px] text-slate-600 break-all select-all mt-1.5">
                      {link.url}
                    </div>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="text-[10px] text-slate-400">{link.details}</p>
                  </div>
                </div>
              ))}
            </div>
