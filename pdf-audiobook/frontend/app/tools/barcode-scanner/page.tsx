      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-8 w-full">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-slate-900">QR & Barcode Scanner</h1>
          </div>
        ...
        {barcodes.length > 0 ? (
          <section className="space-y-4 animate-fade-in">
            <h2 className="font-semibold text-slate-900 text-lg">Decoded Barcodes & QR Codes</h2>
            <div className="space-y-2">
                ...
                <div key={idx} className="p-4 bg-white shadow-sm border border-slate-200/80 border border-slate-200 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-slate-500 font-mono">Page {code.pageNumber}</span>
                      <span className="px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-300 font-bold border border-cyan-500/25">
                        {code.type}
                      </span>
                    </div>
                    <div className="bg-black/30 p-2 rounded border border-slate-200/60 font-mono text-[10px] text-yellow-100 break-all select-all mt-2">
                      {code.value}
                    </div>
                  </div>
                </div>
